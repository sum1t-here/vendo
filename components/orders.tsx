  ...
  return (
    <div className="pt-7 px-7 md:px-14 min-h-screen">
      <div className="flex flex-col gap-6">
        {orders.map(order => (
          <div key={order.id} className="border-2 border-black shadow-[6px_6px_0px_#000]">
            {/* Order Header */}
              ...
              <TableBody>
                {order.items.map(item => (
                  <TableRow key={item.id} className="border-b border-black last:border-0 bg-secondary-background">
                    ...
                    <TableCell className="text-muted-foreground text-sm">{item.variantValue}</TableCell>
            ...
            {order.shippingAddress?.address1 && (
              <div className="p-4 border-t-2 border-black bg-secondary-background">
                <p className="text-xs font-black uppercase tracking-widest text-muted-foreground mb-1">Shipped To</p>
